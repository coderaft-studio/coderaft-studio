...
const demos = [
  ...
  { title:"CoderaftBoard",     subcat:"Dashboard — Business Analytics",         desc:"Dashboard UMKM dengan CRUD produk, manajemen pesanan real-time, update status, dan analytics chart interaktif.",             url:"https://board.coderaft.web.id",              color:"from-violet-600 to-purple-600",  emoji:"📊",  cat:"Dashboard",    lang:"id", pageType:"multi", tags:["Dashboard","CRUD","Analytics"] },
